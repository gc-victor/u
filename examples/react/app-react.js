...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  function t(t2) {
    return function t3(r2, s, c) {
      return s === void 0 && (s = ""), c === void 0 && (c = ""), Object.keys(r2).map(function(o) {
        ...
        if (typeof u2 == "object") {
          var a = /^@m/.test(o);
          return t3(u2, a ? s : (s + o).replace(" ", ""), a ? o : c);
        }
        var d = o + u2 + s + (c || "");
        if (n.classesNames[d])
          return n.classesNames[d];
        var i = "c" + d.split("").reduce(function(e2, n2) {
        ...
        return function(t4) {
          ...
          return s2 ? s2 + "{" + c2 + "}" : c2;
        }(i, o, u2, s, c)), n.classesNames[d] = i, i;
      }).join(" ");
    }(t2);
  }
  ...
  // src/react-component.js
  function u({ attributes: attributes3, children, tag, defaultProps = {}, ...rest }) {
    const props = rest || {};
    const forwardedRef = props.forwardedRef;
    const ref = props.forwardedRef ? { ref: forwardedRef } : {};
    return React.createElement(props.tag || tag, updateProps({ attributes: attributes3, props: { ...defaultProps, ...props, ...ref } }), children || props.children);
  }
  var U = u;
  ...
  // examples/react/ui/box.js
  init_react_shim();
  function Box(props) {
    return u({ tag: "div", ...props });
  }

  // examples/react/ui/button.jsx
  init_react_shim();
  var attributes = [
    "disabled",
    "form",
  ...
  var FancyInput = React2.forwardRef((props, ref) => {
    return /* @__PURE__ */ React2.createElement(Input, {
      forwardedRef: ref,
      ...props
    });
  });
  var CounterButton = ({ children, ...props }) => /* @__PURE__ */ React2.createElement(Button, {
    background: "#eee",
    border: "0",
    borderRadius: "4px",
    color: "black",
  ...
  var Counter = () => {
    return /* @__PURE__ */ React2.createElement(Box, null, /* @__PURE__ */ React2.createElement(Heading, null, "Counter - React"), /* @__PURE__ */ React2.createElement(Flex, null, /* @__PURE__ */ React2.createElement(CounterButton, {
      onClick: increment
    }, /* @__PURE__ */ React2.createElement(Text, null, "+")), /* @__PURE__ */ React2.createElement(FancyInput, {
      borderRadius: "4px",
      ...
      type: "number",
      value: count
    }), /* @__PURE__ */ React2.createElement(CounterButton, {
      onClick: decrement
    }, /* @__PURE__ */ React2.createElement(Text, null, "-"))));
  };
  var app = document.getElementById("app");
  import_react_dom.default.render(/* @__PURE__ */ React2.createElement(Counter, null), app);
})();
/*
object-assign
(c) Sindre Sorhus
